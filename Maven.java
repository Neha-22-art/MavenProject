...
public class Maven {
	...
	public static void main(String[] args) {
		  ...
		  int quantity=0;
		  int total_candies=0;
		  int total_weight = 0,weight = 0,totalbox_wt = 0;
		  char n1;
		  Sweets1 collect;
		  Boolean n=true;     
		    ...
		    switch(sc.next().charAt(0))
		    {
		     case '1':
			   System.out.println("please enter the quantity");
		           ...
		           {
		            n=false;
		            System.out.println("Total weight of gift box is:"+totalbox_wt+"grams");                                               System.out.println("Total number of candies in the giftbox is:"+total_candies);
		            break;
		           }
		     case '2':
		            System.out.println("please enter the quantity");
